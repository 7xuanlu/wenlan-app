...
- **App checkout:** `/Users/lucian/Repos/wenlan-app/.worktrees/wenlan-app-remaining-route-audit`
- **App branch:** `codex/wenlan-app-remaining-route-audit`
...
| remaining direct route gaps | `/api/config/skip-apps`, `/api/context`, `/api/debug/pipeline`, `/api/memory/entities/{entity_id}/observations`, `/api/memory/link-entity`, `/api/memory/relations`, `/api/ping`, `/api/steep`, `/ws/updates` | classified in `docs/superpowers/refactor/2026-06-29-wenlan-app-remaining-route-gaps.md`; graph-authoring boundary proposed in `docs/superpowers/refactor/2026-06-29-wenlan-app-graph-authoring-design.md` | avoid raw wrappers for superseded, agent/operator, and graph-authoring routes; graph authoring should be backend-first/refinement-first if product needs it | not required for desktop P0/P1 parity without a designed surface |
