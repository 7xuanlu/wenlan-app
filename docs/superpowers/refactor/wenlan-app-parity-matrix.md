...
- **App branch:** `codex/wenlan-app-space-move-wrapper`
...
| API route diff | 123 backend paths / 112 app paths / 11 missing app direct paths / 0 app-only paths | `docs/superpowers/refactor/wenlan-app-inventory/api-route-diff.md` |
