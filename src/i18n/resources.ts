...
const en = {
  ...
  connectMatrix: {
    ...
    claudeCodePrimary: "Add Wenlan to Claude Code from your terminal:",
...
const zhHans = {
  ...
  connectMatrix: {
    ...
    claudeCodePrimary: "在终端中将 Wenlan 添加到 Claude Code：",
    claudeCodeCommand1: "claude plugin marketplace add 7xuanlu/wenlan",
    claudeCodeCommand2: "claude plugin install wenlan@7xuanlu-wenlan",
    claudeCodeReload: "然后运行 /reload-plugins 或重启 Claude Code。",
    claudeCodePrompt:
      "帮我将 Wenlan 添加到 Claude Code。直接运行这些 shell 命令（/plugin 菜单无法由代理操作，请使用非交互式命令）：`claude plugin marketplace add 7xuanlu/wenlan`，然后 `claude plugin install wenlan@7xuanlu-wenlan`。批准出现的任何权限提示。完成后运行 /reload-plugins 或让我重启 Claude Code。",
...
const zhHant = {
  ...
  connectMatrix: {
    ...
    claudeCodePrimary: "在終端機中將 Wenlan 新增到 Claude Code：",
    claudeCodeCommand1: "claude plugin marketplace add 7xuanlu/wenlan",
    claudeCodeCommand2: "claude plugin install wenlan@7xuanlu-wenlan",
    claudeCodeReload: "然後執行 /reload-plugins 或重新啟動 Claude Code。",
    claudeCodePrompt:
      "幫我將 Wenlan 新增到 Claude Code。直接執行這些 shell 命令（/plugin 選單無法由代理操作，請使用非互動式命令）：`claude plugin marketplace add 7xuanlu/wenlan`，然後 `claude plugin install wenlan@7xuanlu-wenlan`。核准出現的任何權限提示。完成後執行 /reload-plugins 或讓我重新啟動 Claude Code。",
